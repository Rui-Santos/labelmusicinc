<?php /* Smarty version Smarty-3.1.18, created on 2014-08-04 16:44:52
...
<?php if ($_valid && !is_callable('content_536ce55987aa90_26787387')) {function content_536ce55987aa90_26787387($_smarty_tpl) {?></div>
</div>
...
res.php?l=assets/js/bootstrap.min|assets/js/jquery.backstretch.min|assets/js/pageslide|assets/js/classie|assets/js/jquery-ui.min|assets/plugins/player/jquery.jplayer.min|assets/js/pace.min|assets/js/jquery.mCustomScrollbar.concat.min|assets/js/carousel.min|assets/plugins/director/director.min|assets/js/app.fb-connect|assets/js/app&extend=.js"></script>
...
<!-- <script src="<?php echo $_smarty_tpl->tpl_vars['path']->value;?>
plugins/plupload/plupload.full.min.js"></script> -->
<!-- <script src="<?php echo $_smarty_tpl->tpl_vars['path']->value;?>
plugins/plupload/jquery.plupload.queue/jquery.plupload.queue.js"></script> -->
<script src="<?php echo $_smarty_tpl->tpl_vars['link']->value;?>
res.php?l=assets/plugins/plupload/plupload.full.min|assets/plugins/plupload/jquery.plupload.queue/jquery.plupload.queue"></script>
<script src="<?php echo $_smarty_tpl->tpl_vars['path']->value;?>
js/upload.controller.js"></script>
<?php }?>
<!-- <script src="<?php echo $_smarty_tpl->tpl_vars['path']->value;?>
js/app.fb-connect.js"></script> -->

<script>LMI.path=window.location.protocol + '<?php echo $_smarty_tpl->tpl_vars['path']->value;?>
';
...
<?php } else { ?>0<?php }?>';
LMI.values.owner_name='<?php if (($_smarty_tpl->tpl_vars['is_user']->value!="false")) {?><?php echo $_smarty_tpl->tpl_vars['user']->value;?>
<?php } else { ?>0<?php }?>';</script>


<script type="text/javascript">var switchTo5x=true;</script>
<script type="text/javascript" src="http://w.sharethis.com/button/buttons.js"></script>
<script type="text/javascript">stLight.options({publisher: "25879778-a73e-402c-9bc3-147d3920b22e", doNotHash: false, doNotCopy: false, hashAddressBar: false});</script>
</body>
</html><?php }} ?>
